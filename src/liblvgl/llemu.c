...
static void touch_bits_update_pressed(lv_obj_t *btn) {
  lcd_s_t *lcd =
      lv_obj_get_parent(lv_obj_get_parent(lv_obj_get_parent(btn)))->user_data;
...
static lv_obj_t *_create_lcd_dummy(void) {
  ...
  lv_obj_set_style_bg_color(lcd_dummy, lv_color_hex(0x808080),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(lcd_dummy, lv_color_hex(0x808080),
                                LV_STATE_DEFAULT);
  return lcd_dummy;
}
...
static lv_obj_t *_create_frame(lv_obj_t *lcd_dummy) {
  ...
  lv_obj_set_style_border_color(frame, lv_color_hex(0x808080),
                                LV_STATE_DEFAULT);
...
static lv_obj_t *_create_screen(lv_obj_t *frame) {
  ...
  lv_obj_set_style_border_color(screen, lv_color_hex(0x606060),
                                LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(
      screen, &pros_font_dejavu_mono_18,
      LV_STATE_DEFAULT); // TODO: does this need to be 20px?
...
static lv_obj_t *_create_btn_container(lv_obj_t *frame) {
  ...
  lv_obj_set_style_bg_color(btn_container, lv_color_hex(0xA0A0A0),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(btn_container, lv_color_hex(0x808080),
                                LV_STATE_DEFAULT);
...
static lv_obj_t *_create_btn_left(lv_obj_t *btn_container) {
  ...
  lv_obj_set_style_bg_color(btn_left, lv_color_hex(COL_BTN_NORMAL),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(btn_left, lv_color_hex(COL_BTN_PRESSED),
                            LV_STATE_PRESSED);
  lv_obj_set_style_bg_grad_dir(btn_left, LV_STATE_DEFAULT | LV_STATE_PRESSED,
                               LV_GRAD_DIR_VER);
...
static lv_obj_t *_create_btn_center(lv_obj_t *btn_container) {
  ...
  lv_obj_set_style_bg_color(btn_center, lv_color_hex(COL_BTN_NORMAL),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(btn_center, lv_color_hex(COL_BTN_PRESSED),
                            LV_STATE_PRESSED);
  lv_obj_set_style_bg_grad_dir(btn_center, LV_STATE_DEFAULT | LV_STATE_PRESSED,
                               LV_GRAD_DIR_VER);
...
static lv_obj_t *_create_btn_right(lv_obj_t *btn_container) {
  ...
  lv_obj_set_style_bg_color(btn_right, lv_color_hex(COL_BTN_NORMAL),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(btn_right, lv_color_hex(COL_BTN_PRESSED),
                            LV_STATE_PRESSED);
  lv_obj_set_style_bg_grad_dir(btn_right, LV_STATE_DEFAULT | LV_STATE_PRESSED,
                               LV_GRAD_DIR_VER);
...
static lv_obj_t *_create_lcd(void) {
  ...
  lv_obj_set_style_bg_color(lv_scr_act(), lv_color_hex(0x404040),
                            LV_STATE_DEFAULT);
...
bool _lcd_vprint(lv_obj_t *lcd_dummy, int16_t line, const char *fmt,
                 va_list args) {
  if (line < 0 || line > 7) {
    errno = EINVAL;
    return false;
...
void lcd_set_text_align(text_align_e_t alignment) { text_align = alignment; }
...
bool lcd_is_initialized(void) { return _lcd_is_initialized; }
