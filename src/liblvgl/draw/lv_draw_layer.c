...
lv_draw_layer_ctx_t *lv_draw_layer_create(lv_draw_ctx_t *draw_ctx,
  ...
  lv_draw_layer_ctx_t *init_layer_ctx =
      draw_ctx->layer_init(draw_ctx, layer_ctx, flags);
...
void lv_draw_layer_adjust(struct _lv_draw_ctx_t *draw_ctx,
                          struct _lv_draw_layer_ctx_t *layer_ctx,
                          lv_draw_layer_flags_t flags) {
  if (draw_ctx->layer_adjust)
    draw_ctx->layer_adjust(draw_ctx, layer_ctx, flags);
}

void lv_draw_layer_blend(struct _lv_draw_ctx_t *draw_ctx,
                         struct _lv_draw_layer_ctx_t *layer_ctx,
                         lv_draw_img_dsc_t *draw_dsc) {
  if (draw_ctx->layer_blend)
    draw_ctx->layer_blend(draw_ctx, layer_ctx, draw_dsc);
}

void lv_draw_layer_destroy(lv_draw_ctx_t *draw_ctx,
  ...
  if (draw_ctx->layer_destroy)
    draw_ctx->layer_destroy(draw_ctx, layer_ctx);
  lv_mem_free(layer_ctx);
}
