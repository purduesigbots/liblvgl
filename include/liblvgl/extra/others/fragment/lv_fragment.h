...
typedef struct _lv_fragment_managed_states_t {
  ...
  bool obj_created;
  /**
   * true before `lv_fragment_del_obj` is called. Don't touch any object if this
   * is true
   */
  bool destroying_obj;
  /**
 ...
 * @param parent Parent fragment if this manager is placed inside another
...
/**
 * Delete object created by all fragments managed by this manager. Instance of
 * fragments will not be deleted.
 * @param manager Fragment manager instance
 */
...
/**
 * Detach and destroy fragment. If fragment is in navigation stack, remove from
 * it.
 * @param manager Fragment manager instance
 * @param fragment Fragment instance
 */
