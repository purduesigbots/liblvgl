...
typedef struct {
  ...
  char k9_input_str[LV_IME_PINYIN_K9_MAX_INPUT]; /* 9-key input(k9) mode input
                                                    string */
...
#endif
  uint16_t
      ta_count; /* The number of characters entered in the text box this time */
  ...
  uint8_t mode : 1;    /* Set mode, 1: 26-key input(k26), 0: 9-key input(k9).
                          Default: 1. */
} lv_ime_pinyin_t;
