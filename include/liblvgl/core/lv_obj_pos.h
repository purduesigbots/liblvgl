 ...
 * @param obj           pointer to an object whose style properties should be
 * used
 ...
 */
void lv_obj_transform_point(const struct _lv_obj_t *obj, lv_point_t *p,
 ...
 * @param inv           do the inverse of the transformation (-angle and 1/zoom)
 */
void lv_obj_get_transformed_area(const struct _lv_obj_t *obj, lv_area_t *area,
                                 bool recursive, bool inv);
