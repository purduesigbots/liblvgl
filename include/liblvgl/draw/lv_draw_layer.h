...
/**
 * Create a new layer context. It is used to start and independent rendering
 ...
 */
struct _lv_draw_layer_ctx_t *
lv_draw_layer_create(struct _lv_draw_ctx_t *draw_ctx,
                     const lv_area_t *layer_area, lv_draw_layer_flags_t flags);
 ...
 * @param layer_ctx     pointer to a layer context
 */
void lv_draw_layer_destroy(struct _lv_draw_ctx_t *draw_ctx,
                           struct _lv_draw_layer_ctx_t *layer_ctx);
